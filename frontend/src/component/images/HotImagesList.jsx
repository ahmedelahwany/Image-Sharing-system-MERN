...
class HotImagesList extends React.Component{
    ...
    _updateStateFromStore(){
        ...
        this.setState({
            ...
            hotImages: store._Images.HotImages,
    ...
    render() {
        return (
            <div className='d-flex m-4 justify-content-center flex-column'>
                <ErrorMessageWell/>
                <h3>Hot Images</h3>
            <div  className='d-flex m-4 justify-content-around align-items-center flex-row flex-wrap'>
                {
                    this.state.hotImages.map(({_id,createdAt, likes, upvotes, image}) => {
                        return (
                            <Image key={_id}
                                   _id={_id}
                                   createdAt={createdAt}
